    ...
    >
      ...
      {position2 && (
        ...
        >
          ...
          />
          <p className="text-xl font-semibold text-white">{position2.score}</p>
        </div>
      )}
      ...
      {position1 && (
        ...
        >
          ...
          <img
            ...
            style={{ backdropFilter: "blur(10px)" }}
          />
          <p className="text-xl font-semibold text-white">{position1.score}</p>
        </div>
      )}
      ...
      {position3 && (
        ...
        >
          ...
          <img
            ...
            style={{ backdropFilter: "blur(10px)" }}
          />
          <p className="text-xl font-semibold text-white">{position3.score}</p>
        </div>
      )}
    </div>
    </>
