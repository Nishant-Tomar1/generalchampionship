  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-col text-center w-full mb-10">
        <h1 className="text-2xl md:text-5xl font-bold title-font mb-4 text-pink-700">Organizing Team</h1>
      ...
      <div className="flex items-center justify-center flex-wrap -m-4">
        ...
        {team.map((person) => 
            ...
            <div className="h-full flex flex-col items-center text-center">
              <img alt="team" className="flex-shrink-0 rounded-lg w-full h-48 object-cover object-center mb-4" src="https://dummyimage.com/200x200" />
